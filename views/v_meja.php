...
<head>
	...
	<title>DJ Resto | Kelola Meja</title>
			...
			<div class="container-fluid content-top-gap">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb my-breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Kelola Meja</li>
					</ol>
				</nav>
				<!-- End Breadcrumb -->
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card card_border border-primary-top">
								...
								<div class="card-body">
									<a href="tambah_meja.php" class="btn btn-primary text-light mb-3"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Meja</a>
									...
									<div class="card card_border border-top shadow p-3 mb-4">
										...
										<div class="table-responsive">
											<table id="table_dataMeja" class="display" style="width: 100%;">
												<thead>
													<tr>
														<th>Kode Meja</th>
														<th>Nama Meja</th>
												...
												<tbody>
													<?php while($meja = mysqli_fetch_object($data2)) { ?>
														<tr>
															<td><span class="badge badge-success"><?php echo $meja->kd_meja?></span></td>
															<td><?php echo $meja->nama_meja?></td>
															<td>
																<a href="ubah_meja.php?kd_meja=<?php echo $meja->kd_meja?>" class="btn btn-warning text-light mr-2"><i class="fa fa-pencil"></i></a>
																<a href="hapus_meja.php?kd_meja=<?php echo $meja->kd_meja?>" class="btn btn-danger text-light btnHapus" data-nama="<?php echo $meja->nama_meja?>"><i class="fa fa-trash"></i></a>
															</td>
														</tr>
													<?php } ?>
												</tbody>
				...
				<!-- Modal Hapus Meja -->
				<div class="modal fade modalMeja" tabindex="-1" role="dialog" aria-labelledby="HapusMeja" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								Apakah Anda ingin menghapus <b id="nama"></b> ?
							</div>
