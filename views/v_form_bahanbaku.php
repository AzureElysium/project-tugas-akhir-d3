...
<head>
	...
	<title>DJ Resto | <?php echo $form?> - Data Bahan Baku</title>
...
<body onload="fokus()">
			...
			<div class="container-fluid content-top-gap">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb my-breadcrumb">
						...
						<li class="breadcrumb-item"><a href="data_bb.php">Data Bahan Baku</a></li>
						<li class="breadcrumb-item active" aria-current="page"><?php echo $form?> Bahan Baku</li>
					</ol>
				</nav>
				<!-- End Breadcrumb -->
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<div class="card card_border border-primary-top">
								<form name="form_bahanbaku" action="<?php echo $action?>" id="needs-validation" method="POST" novalidate>
									<div class="card-header chart-grid__header">
										<?php echo $form?> Bahan Baku
									</div>

									<div class="card-body">
										<a href="data_bb.php" class="btn btn-warning text-light mb-3"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;Kembali</a>
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<?php
														...
														$kodeBB = $dat['kdTerbesar'];

														$urutan = (int) substr($kodeBB, 2, 3);
														$urutan++;

														$huruf = 'BB';
														$kodeBB = $huruf . sprintf("%03s", $urutan);
													?>

													<div class="form-group mb-4">
														<label class="input__label">Kode Bahan Baku</label>
														<input type="text" name="kd_bahanbaku" class="form-control input-style" value="<?php echo ($form == 'Tambah') ? $kodeBB : @$result->kd_bahanbaku?>" readonly required>
													</div>

													<div class="form-group mb-4">
														<label class="input__label">Nama Bahan Baku</label>
														<input type="text" name="nama_bahanbaku" class="form-control input-style" placeholder="Isi Nama Bahan Baku" value="<?php echo @$result->nama_bahanbaku?>" required>
														<div class="invalid-feedback">Tolong diisi Nama Bahan Baku.</div>
													</div>

													<div class="form-group mb-4">
														<label class="input__label">Jumlah Tersedia (Kg)</label>
														<input type="number" step="0.000001" name="jumlah_bahanbaku" id="jumlah_bahanbaku" class="form-control input-style" placeholder="Isi Jumlah Bahan Baku Tersedia" value="<?php echo @$result->jumlah_bahanbaku?>" required>
														<div class="invalid-feedback">Tolong diisi Jumlah Bahan Baku Tersedia.</div>
													</div>
												</div>
	...
	<script type="text/javascript">
		function fokus() {
			document.form_bahanbaku.nama_bahanbaku.focus();
		}
	</script>
	<!-- End Focus -->
