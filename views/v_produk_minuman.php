...
<head>
	...
	<title>DJ Resto | Kelola Produk Minuman</title>
	...
	<section>
		...
		<div class="main-content">
			<div class="container-fluid content-top-gap">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card card_border border-primary-top">
								...
								<div class="card-body">
									<a href="tambah_produkMinuman.php" class="btn btn-primary text-light mb-3"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Minuman</a>

									<div class="card card_border border-top shadow p-3">
										<div class="table-responsive">
											<table id="table_infoMinuman" class="display" style="width: 100%;">
												<thead>
													<tr>
														<th>Nama Minuman</th>
														<th>Kode Produk</th>
												...
												<tbody>
													<?php while($minuman = mysqli_fetch_object($data2)) { ?>
														<tr>
															<td><?php echo $minuman->nama_produk?></td>
															<td><span class="badge badge-danger"><?php echo $minuman->kd_produk?></span></td>
															<td><?php echo $minuman->kategori_produk?></td>
															<td><?php echo rupiah($minuman->harga)?></td>
															<td>
																<a href="ubah_produkMinuman.php?kd_produk=<?php echo $minuman->kd_produk?>" class="btn btn-warning text-light mr-2"><i class="fa fa-pencil"></i></a>
																<a href="hapus_produkMinuman.php?kd_produk=<?php echo $minuman->kd_produk?>" class="btn btn-danger text-light btnHapus" data-nama="<?php echo $minuman->nama_produk?>"><i class="fa fa-trash"></i></a>
															</td>
														</tr>
													<?php } ?>
												</tbody>
				...
				<!-- Modal Hapus Minuman -->
				<div class="modal fade modalMinuman" tabindex="-1" role="dialog" aria-labelledby="HapusMinuman" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								Apakah Anda ingin menghapus minuman <b id="nama"></b> ?
							</div>
