...
<head>
	...
	<title>DJ Resto | <?php echo $form?> - Data Supplier</title>
...
<body onload="fokus()">
			...
			<div class="container-fluid content-top-gap">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb my-breadcrumb">
						...
						<li class="breadcrumb-item"><a href="data_supp.php">Data Supplier</a></li>
						<li class="breadcrumb-item active" aria-current="page"><?php echo $form?> Supplier</li>
					</ol>
				</nav>
				<!-- End Breadcrumb -->

				<!-- Form Tambah/Ubah Supplier -->
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<div class="card card_border border-primary-top">
								<form name="form_supplier" action="<?php echo $action?>" id="needs-validation" method="POST" novalidate>
									<div class="card-header chart-grid__header">
										<?php echo $form?> Supplier
									</div>

									<div class="card-body">
										<a href="data_supp.php" class="btn btn-warning text-light mb-3"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;Kembali</a>
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<?php
														...
														$kodeSupp = $dat['kdTerbesar'];

														$urutan = (int) substr($kodeSupp, 3, 2);
														$urutan++;

														$huruf = 'SUP';
														$kodeSupp = $huruf . sprintf("%02s", $urutan);
													?>

													<div class="form-group mb-4">
														<label class="input__label">Kode Supplier</label>
														<input type="text" name="kd_supplier" class="form-control input-style" value="<?php echo ($form == 'Tambah') ? $kodeSupp : @$result->kd_supplier?>" readonly required>
													</div>

													<div class="form-group mb-4">
														<label class="input__label">Nama Supplier</label>
														<input type="text" name="nama_supplier" class="form-control input-style" placeholder="Isi Nama Supplier" value="<?php echo @$result->nama_supplier?>" required>
														<div class="invalid-feedback">Tolong diisi Nama Supplier.</div>
													</div>

													<div class="form-group mb-4">
														<label class="input__label">Alamat</label>
														<textarea name="alamat_supplier" class="form-control input-style" placeholder="Isi Alamat Lengkap Supplier" required><?=isset($_POST['alamat_supplier']) ? $alamat_supplier : @$result->alamat_supplier?></textarea>
														<div class="invalid-feedback">Tolong diisi Alamat Lengkap Supplier.</div>
													</div>

													<div class="form-group mb-4">
														<label class="input__label">No. Telp</label>
														<input type="text" name="telp_supplier" class="form-control input-style" placeholder="Isi Nomor Telepon Supplier" id="telp_supplier" pattern="^\d{11,12}$" maxlength="12" value="<?=isset($_POST['telp_supplier']) ? $telp_supplier : @$result->telp_supplier?>" required>
														<div class="invalid-feedback">Membutuhkan 11-12 Angka Nomor Telepon.</div>
													</div>
												</div>
	...
	<script type="text/javascript">
		function fokus() {
			document.form_supplier.nama_supplier.focus();
		}
	</script>
	<!-- End Focus -->
