...
<head>
	...
	<title>DJ Resto | Laporan Penjualan Produk</title>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card card_border border-primary-top">
								...
								<div class="card-body">
									<form action="cetak_laporanPenProdukPeriode.php" id="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
									...
									<div class="card card_border border-top shadow p-3">
										<div class="table-responsive">
											<table id="table_penProduk" class="display" style="width: 100%;">
												<thead>
													<tr>
														<th>Kode Produk</th>
														<th>Nama Produk</th>
												...
												<tbody>
													<?php while($penproduk = mysqli_fetch_object($data2)) { ?>
														<tr>
															<td>
																<?php if(substr($penproduk->kd_produk, -5, 2) == 'MK') { ?>
																	<span class="badge badge-success"><?php echo $penproduk->kd_produk?></span>
																<?php } else { ?>
																	<span class="badge badge-danger"><?php echo $penproduk->kd_produk?></span>
																<?php } ?>
															</td>
															<td><?php echo $penproduk->nama_produk?></td>
															<td><?php echo $penproduk->kategori_produk?></td>
															<td><span class="badge badge-info badge-pill"><?php echo $penproduk->TotalQty?> pcs</span></td>
															<td><?php echo rupiah($penproduk->TotalPenjualan)?></td>
														</tr>
													<?php } ?>
												</tbody>
											</table>
									...
									<div class="form-gorup mt-4 text-center">
										<a href="cetak_laporanPenProduk.php" type="button" class="btn btn-primary text-light" target="_blank"><i class="fa fa-print"></i> Cetak Penjualan Produk</a>
									</div>
								</div>
							</div>
						</div>
