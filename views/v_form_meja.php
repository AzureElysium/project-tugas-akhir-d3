...
<head>
	...
	<title>DJ Resto | Kelola Meja - <?php echo $form?> Data Meja</title>
...
<body onload="fokus()">
		...
		<div class="sidebar-menu sticky-sidebar-menu">
			...
			<div class="sidebar-menu-inner">
				<ul class="nav nav-pills nav-stacked custom-nav">
					...
					<li class="active"><a href="data_meja.php"><i class="fa fa-table"></i> <span>Kelola Meja</span></a></li>
			...
			<div class="container-fluid content-top-gap">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb my-breadcrumb">
						...
						<li class="breadcrumb-item"><a href="data_meja.php">Kelola Meja</a></li>
						<li class="breadcrumb-item active" aria-current="page"><?php echo $form?> Meja</li>
					</ol>
				</nav>
				<!-- End Breadcrumb -->

				<!-- Form Tambah/Ubah Meja -->
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<div class="card card_border border-primary-top">
								<form name="form_meja" action="<?php echo $action?>" id="needs-validation" method="POST" novalidate>
									<div class="card-header chart-grid__header">
										<?php echo $form?> Meja
									</div>

									<div class="card-body">
										<a href="data_meja.php" class="btn btn-warning text-light mb-3"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;Kembali</a>
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<?php
														...
														$kodeMeja = $dat['kdTerbesar'];

														$urutan = (int) substr($kodeMeja, 2, 2);
														$urutan++;

														$huruf = 'MJ';
														$kodeMeja = $huruf . sprintf("%02s", $urutan);
													?>

													<div class="form-group mb-4">
														<label class="input__label">Kode Meja</label>
														<input type="text" name="kd_meja" class="form-control input-style" value="<?php echo ($form == 'Tambah') ? $kodeMeja : @$result->kd_meja?>" readonly required>
													</div>

													<div class="form-group mb-4">
														<label class="input__label">Nama Meja</label>
														<input type="text" name="nama_meja" class="form-control input-style" placeholder="Isi Nama Meja" value="<?php echo @$result->nama_meja?>" required>
														<div class="invalid-feedback">Tolong diisi Nama Meja.</div>
													</div>
												</div>
	...
	<script type="text/javascript">
		function fokus() {
			document.form_meja.nama_meja.focus();
		}
	</script>
	<!-- End Focus -->
