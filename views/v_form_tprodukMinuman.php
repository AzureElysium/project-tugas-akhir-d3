...
<head>
	...
	<title>DJ Resto | Kelola Produk - Tambah Minuman</title>
...
<body>
			...
			<div class="container-fluid content-top-gap">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb my-breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Tambah Minuman</li>
					</ol>
				</nav>
				<!-- End Breadcrumb -->
							...
							<div class="card card_border border-top shadow p-3">
								<div class="row border-bottom">
									<div class="col-lg-6 border-right">
										...
										<div class="form-group row mb-4">
											...
											<div class="col-sm-8">
												<input type="text" name="nama_produk" id="nama_produk" class="form-control input-style" placeholder="Isi Nama Minuman">
											</div>
										</div>
										...
										<div class="form-group row mb-4">
											...
											<div class="col-sm-8">
												<input type="text" name="kategori_produk" id="kategori_produk" class="form-control input-style" value="Minuman" readonly>
											</div>
										</div>
								...
								<table class="table table-bordered table-hover mt-4 mb-4">
									...
									<tbody id="tabel_bbminuman">
										<?php include 'tampil_databbminuman.php';?>
									</tbody>
								</table>
							</div>

							<div class="form-group text-center">
								<button type="button" name="simpan_minuman" id="simpan_minuman" class="btn btn-success text-light mt-4"><i class="fa fa-save"></i>&nbsp;&nbsp;Simpan</button>
							</div>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
			...
			if(kd_bahanbaku == '' ) {
				...
				$.ajax({
					...
					success: function() {
						...
						$('#jumlah_dibutuhkan').val('');
						$('#kd_bahanbaku').focus();
						$('#tabel_bbminuman').load('<?php echo base_url()?>/tampil_databbminuman.php', function() {
							calculate();
						});
					}
				});
		...
		$(document).on('click', '#simpan_minuman', function() {
			var kd_produk = $('#kd_produk').val();
			...
			if(nama_produk == '') {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url()?>/tambah_produkMinuman.php',
					data: ({'simpan_minuman' : true, 'kd_produk' : kd_produk, 'nama_produk' : nama_produk, 'kategori_produk' : kategori_produk, 'harga' : harga}),
					success: function() {
						Swal.fire({
							icon: 'success',
						  	title: 'Sukses!',
