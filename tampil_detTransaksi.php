...
?>
	<tr>
		...
		<td class="text-center">
			<a href="hapus_detTransaksi.php?kd_transaksi=<?php echo $kd_transaksi?>&kd_produk=<?php echo $kd_produk?>" data-nama="<?php echo $nama_produk?>" data-qty="<?php echo $qty?>" class="btn btn-danger text-light btnHapus"><i class="fa fa-trash-o"></i></a>
		</td>
	</tr>
<?php } } else { ?>
	<tr>
