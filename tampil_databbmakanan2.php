...
?>
	<tr>
		...
		<td class="text-center">
			<a href="hapus_dataBBMakanan.php?kd_produk=<?php echo $kd_produk?>&kd_bahanbaku=<?php echo $kd_bahanbaku?>" data-nama="<?php echo $nama_bahanbaku?>" class="btn btn-danger text-light btnHapus"><i class="fa fa-trash-o"></i></a>
		</td>
	</tr>
<?php } } else { ?>
	<tr>
